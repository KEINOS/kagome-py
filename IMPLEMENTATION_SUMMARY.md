...
| `macos-12` | darwin | amd64 | .dylib | macosx_10_13_x86_64 |
| `ubuntu-latest` | linux | amd64 | .so | manylinux_2_35_x86_64 |
| `ubuntu-24.04-arm` | linux | arm64 | .so | manylinux_2_35_aarch64 |
...
- [x] `auditwheel show` (Linux) — manylinux_2_35 compliance verified
